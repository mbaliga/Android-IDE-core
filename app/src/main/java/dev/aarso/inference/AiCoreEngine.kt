 ...
 * 8+/9 class, a Galaxy S24 subset) — [dev.aarso.ui.onboarding.AiCoreAvailability] probes for it
 * before this is ever offered, and [dev.aarso.inference.EngineProvider] falls back cleanly (this
 ...
 * same posture as [dev.aarso.inference.cloud.CloudEngine] for the capabilities a remote/managed
 * engine can't offer.
 */
class AiCoreEngine(private val appContext: Context) : InferenceEngine {
     ...
     *  [dev.aarso.inference.cloud.CloudEngine] uses for providers with no exposed tokenizer. */
