 ...
 *
 * Pure Kotlin, same shape/precedent as [dev.aarso.domain.cost.UsageReport]: a plain
 * data class the per-provider [dev.aarso.inference.cloud.CloudEngine] subclasses parse
