 ...
 * (`app/src/main/cpp/pty_exec.cpp`), the same approach Termux's terminal-emulator uses. Still
 * runs at this app's own sandboxed uid — no root, no privilege escalation. Feeds the same
 * transport-agnostic [dev.aarso.domain.remote.term.PtyChannel]/[dev.aarso.domain.remote.term.VtParser]
