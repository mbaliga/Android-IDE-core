...
import dev.aarso.domain.thread.DelegationOutcomes.ChoiceStatus.STILL_ACTIVE
import dev.aarso.domain.thread.DelegationOutcomes.ChoiceStatus.SWITCHED_OFF
