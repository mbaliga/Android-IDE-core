...
import dev.aarso.domain.gesture.MessageDragLogic.ARM_MS
import dev.aarso.domain.gesture.MessageDragLogic.DETENT_1_DP
import dev.aarso.domain.gesture.MessageDragLogic.DETENT_2_DP
import dev.aarso.domain.gesture.MessageDragLogic.DOUBLE_TAP_WINDOW_MS
import dev.aarso.domain.gesture.MessageDragLogic.Intent
import dev.aarso.domain.gesture.MessageDragLogic.LONG_PRESS_MS
import dev.aarso.domain.gesture.MessageDragLogic.Phase
import dev.aarso.domain.gesture.MessageDragLogic.RADIAL_HOLD_MS
import dev.aarso.domain.gesture.MessageDragLogic.Sample
import dev.aarso.domain.gesture.MessageDragLogic.resolve
