...
import dev.fonebrew.ui.components.BudgetRingView
import dev.fonebrew.ui.components.InputOutputCard
...
private fun fmtTokens(t: Long): String =
    dev.fonebrew.domain.format.LocaleFormat.tokens(t, java.util.Locale.getDefault())
