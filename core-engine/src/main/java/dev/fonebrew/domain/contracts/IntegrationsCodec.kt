...
import dev.fonebrew.contracts.integrations.AssayProjectRef
import dev.fonebrew.contracts.integrations.AssayToolRef
import dev.fonebrew.contracts.integrations.CsAppIssue
import dev.fonebrew.contracts.integrations.CsAppProducerRef
import dev.fonebrew.contracts.integrations.CsAppProjectRef
import dev.fonebrew.contracts.integrations.FindingFileRef
...
import dev.fonebrew.contracts.integrations.IssueSeverity
import dev.fonebrew.contracts.integrations.IssuesManifest
import dev.fonebrew.contracts.integrations.PreviewChangedRecord
import dev.fonebrew.contracts.integrations.PreviewConflictingRecord
...
import dev.fonebrew.contracts.integrations.ProvingTestEntry
import dev.fonebrew.contracts.integrations.ProvingTestKind
import dev.fonebrew.contracts.integrations.ProvingTestStatus
import dev.fonebrew.contracts.integrations.ProvingTests
import dev.fonebrew.contracts.integrations.ProvingTestsSummary
...
/**
 * WP-7: encode/decode for every `dev.fonebrew.contracts.integrations` wire shape (§ the R1 "freeze
 ...
 * envelope the way `EnvelopeCodec` does for `dev.fonebrew.contracts.common` shapes.
 */
