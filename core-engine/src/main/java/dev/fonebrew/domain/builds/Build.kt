package dev.fonebrew.domain.builds

/**
 * A buildable artifact of an app you develop on Fonebrew (docs/design/app-distribution.md):
...
data class Build(
    ...
    val version: String,
    /** The artifact file name, e.g. `fonebrew-sd.apk`. */
    val name: String,
    val branch: String,
