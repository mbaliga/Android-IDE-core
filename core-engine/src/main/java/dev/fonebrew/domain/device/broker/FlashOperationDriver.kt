...
import dev.fonebrew.contracts.devices.DeviceIdentity
import dev.fonebrew.contracts.devices.DeviceOperation
import dev.fonebrew.contracts.devices.DeviceOperationKind
import dev.fonebrew.contracts.devices.DeviceOperationState
import dev.fonebrew.contracts.devices.DeviceRollbackPlan
import dev.fonebrew.contracts.devices.DeviceSideEffect
import dev.fonebrew.contracts.devices.DeviceVerificationState
import dev.fonebrew.contracts.devices.FirmwareArtifact
import dev.fonebrew.contracts.devices.IdentityConfidenceLevel
import dev.fonebrew.contracts.devices.OperationAuthority
import dev.fonebrew.contracts.devices.OperationPreconditions
import dev.fonebrew.contracts.devices.OperationProtocol
import dev.fonebrew.contracts.devices.OperationReceipt
import dev.fonebrew.contracts.devices.OperationVerification
 ...
 * around already-real pieces, not a rewrite" posture [dev.fonebrew.domain.loop.LoopInstallationDriver]
