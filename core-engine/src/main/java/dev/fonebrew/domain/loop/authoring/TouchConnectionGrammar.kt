 ...
 * accepts an illegal transition, the same fail-closed posture as [dev.fonebrew.domain.workspace.
...
object TouchConnectionGrammar {
    ...
    /**
     * Belt-and-suspenders check, same discipline as [dev.fonebrew.domain.loop.LoopInstallationDriver]'s
