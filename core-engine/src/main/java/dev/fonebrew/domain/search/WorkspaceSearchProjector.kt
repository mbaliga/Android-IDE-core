...
import dev.fonebrew.contracts.search.IndexFreshness
...
object WorkspaceSearchProjector {
     ...
     *   [dev.fonebrew.domain.workspace.BufferReplay.materialize]) -- this projector does not itself
    ...
    /** The [dev.fonebrew.contracts.search.ResultProvenance]-shaped freshness for a just-indexed buffer. */
