 ...
 * sibling branch ([dev.fonebrew.ui.ChatViewModel.switchAlternative] / `rewindFrom`, ordinary use of
 ...
 * ([dev.fonebrew.ui.ChatViewModel]'s delegation-outcome recompute) only ever calls [correlate] for
 ...
 *
 * Pure and JVM-testable, same shape as [dev.fonebrew.domain.curation.CompactionContract.resolve] —
