...
import dev.fonebrew.contracts.integrations.CustomerIssue
...
object CsAppImportLane {
     ...
     * BEFORE attempting [dev.fonebrew.domain.contracts.IntegrationsCodec.decodeIssuesManifest].
     */
    ...
    // a real dev.fonebrew.contracts.integrations.CsAppIssue can't hold an invalid value at all
