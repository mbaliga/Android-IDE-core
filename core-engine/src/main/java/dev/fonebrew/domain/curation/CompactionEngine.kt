 ...
 * [dev.fonebrew.domain.bridge.SummaryBridge]'s own KDoc: *"the summary prose is a model call...
 ...
 * [dev.fonebrew.inference.InferenceEngine] machinery, wired by whatever calls [CompactionEngine.run]
 * — never faked here.
 */
