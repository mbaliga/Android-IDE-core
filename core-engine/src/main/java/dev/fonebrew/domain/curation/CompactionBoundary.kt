 ...
 * caller ([dev.fonebrew.ui.ChatViewModel]) resolves the marker list and the winning [Receipt] from
 * Room/[dev.fonebrew.data.ReceiptStore], this object only decides — so both functions here are fully
...
object CompactionBoundary {
     ...
     *   [dev.fonebrew.data.MessageTreeRepository.path] returns).
