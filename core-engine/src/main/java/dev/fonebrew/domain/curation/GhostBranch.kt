 ...
 * (see [dev.fonebrew.domain.tree.MessageTree]); "rewind" is just moving the session's active-leaf
 * pointer to an earlier node (already-existing [dev.fonebrew.domain.tree.MessageTree] mechanics —
 ...
 *   [dev.fonebrew.domain.tree.MessageTree.pathToRoot], same as any other branch.
 */
...
object Rewind {
     ...
     *   compute this from [dev.fonebrew.domain.tree.MessageTree] since [Rewind] itself has no tree
