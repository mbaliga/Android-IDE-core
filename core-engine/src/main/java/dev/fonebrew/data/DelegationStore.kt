...
/**
 * THREAD_TOPOLOGY_PLAN.md WP1's data gateway for [dev.fonebrew.domain.thread.DelegationEvent] —
 ...
 * Fronts [DelegationEventDao] with one store, same shape [dev.fonebrew.data.CurationStore] uses.
 *
 * `outcome` is tracked **descriptively only** here — this store never interprets KEPT/REVERTED,
 * it only records whatever [dev.fonebrew.domain.thread.DelegationOutcomes.correlate] (a later work
