 ...
 * [dev.fonebrew.contracts.workspace.WorkspaceJournal.checkpoint]/`restore` backing store, WP-3.
 */
@Dao
interface RecoverySnapshotDao {
     ...
     * checkpointed -- [dev.fonebrew.contracts.workspace.WorkspaceJournal.restore]'s "a brand-new
