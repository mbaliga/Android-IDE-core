...
import dev.aarso.ui.state.ThreadRailPresenter
 ...
 * `dev.aarso.ui.loops.LoopRoom`'s own node handles use.
 *
 ...
 *   adds its own `findScrollPrefix` offset (see `dev.aarso.ui.ChatScreen`) — this component never
