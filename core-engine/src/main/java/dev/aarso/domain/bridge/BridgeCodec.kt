...
/**
 * Insert-time metadata codec for a "bridge" [dev.aarso.domain.MessageNode]
 ...
 * ([dev.aarso.ui.components.SummaryNodeCard]) instead wants the deterministic structural payload —
 ...
 *
 * `org.json`-based, same discipline as [dev.aarso.domain.thread.ThreadCodec] — pure JVM, no
