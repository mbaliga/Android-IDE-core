 ...
 * conversation" pair, the other half being [dev.aarso.domain.tree.TreeFork] ("Fork"). Where Fork
 ...
 * render layer ([dev.aarso.ui.components.SummaryNodeCard]) mounts a spawn bridge exactly the way
 ...
 * [dev.aarso.ui.ChatViewModel.openConversation]).
 *
