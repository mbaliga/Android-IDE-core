 ...
 * (`dev.aarso.ui.MessageGestures.kt`) is a thin, owner-verified `awaitEachGesture` wrapper that
 ...
 * message itself never moves — see [dev.aarso.domain.curation.Verdict]'s own KDoc for the same
