 ...
 * [dev.aarso.domain.council.Council]'s own KDoc for the model-as-aggregator opt-in counterpart).
 *
...
object SiblingCompares {
     ...
     *  [dev.aarso.domain.bridge.SummaryBridges]' own bullet-truncation convention, doubled (a
     ...
     *   what "Continue with this" ([dev.aarso.ui.ChatViewModel.branchFrom]) should target, so
     ...
     *   not invention" discipline [dev.aarso.domain.bridge.SummaryBridges.selectCarryForward] uses).
