...
import dev.aarso.contracts.loops.NodeAttempt
import dev.aarso.contracts.loops.NodeAttemptOutcome
import dev.aarso.contracts.loops.RunEvent
import dev.aarso.contracts.loops.RunOutputs
import dev.aarso.contracts.loops.RunState
import dev.aarso.contracts.loops.TerminalReason
import dev.aarso.contracts.loops.TerminalReasonCategory
import dev.aarso.contracts.loops.LoopRun
 ...
 * [dev.aarso.domain.authority.AuthorityEngine] respectively -- this class defaults both to
 * "auto-resolve, nothing to wait for," which is honest for [GraphRunner]'s own scope (an abstract
 * [dev.aarso.domain.council.Generator] seam with no device binding or explicit authority grant of
