 ...
 *
 * Shaped like [ThreadMarker] (`at: Long` epoch millis, plain data class): [dev.aarso.data.DelegationStore]
 * is its Room-backed home, same relationship [dev.aarso.data.CurationStore] has to `Version`.
 *
