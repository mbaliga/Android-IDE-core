 ...
 *
 * Deliberately shaped like [dev.aarso.domain.curation.Version]/[dev.aarso.domain.curation.MessageBookmark]
 ...
 * `MessageNode.metadata`. [dev.aarso.data.ThreadMarkerStore] is its Room-backed home, the same
 * relationship [dev.aarso.data.CurationStore] has to `Version`.
 *
