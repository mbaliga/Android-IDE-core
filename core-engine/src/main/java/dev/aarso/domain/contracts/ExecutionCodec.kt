...
import dev.aarso.contracts.execution.SideEffect
...
import dev.aarso.contracts.execution.ThermalPolicyRef
import dev.aarso.contracts.execution.ThermalState
...
import dev.aarso.contracts.execution.VisibilityContract
import org.json.JSONArray
import org.json.JSONObject
import java.time.Instant

/**
 * Encode/decode for `dev.aarso.contracts.execution` (WP-4), same pattern as [EnvelopeCodec]/
