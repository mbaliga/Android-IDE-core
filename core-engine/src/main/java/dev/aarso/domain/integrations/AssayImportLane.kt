...
import dev.aarso.contracts.integrations.AuditFinding
import dev.aarso.contracts.integrations.AuditFindingLevel
...
object AssayImportLane {
    ...
    /**
     * Same raw-string rationale as [dev.aarso.domain.integrations.CsAppImportLane.
     ...
     * outside this pure function's scope, mirroring [dev.aarso.domain.workspace.
