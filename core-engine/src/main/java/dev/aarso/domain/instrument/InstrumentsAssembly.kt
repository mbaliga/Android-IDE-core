...
import dev.aarso.domain.inspect.TokenScore
...
import dev.aarso.domain.scope.Corpus
 ...
 *     floor ([dev.aarso.domain.scope.ContextAssembly], previously built but callerless per
