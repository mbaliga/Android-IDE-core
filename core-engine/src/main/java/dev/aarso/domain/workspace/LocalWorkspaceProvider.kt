...
import dev.aarso.contracts.workspace.ResourceChange
import dev.aarso.contracts.workspace.ResourceChangeKind
import dev.aarso.contracts.workspace.ResourcePage
import dev.aarso.contracts.workspace.ResourceProvider
import dev.aarso.contracts.workspace.ResourceRead
import dev.aarso.contracts.workspace.ResourceStat
 ...
 * content digest (SHA-256 hex via [dev.aarso.domain.contracts.Digest]), not an mtime -- two writes
 ...
 */
class LocalWorkspaceProvider(private val root: File) : dev.aarso.contracts.workspace.WorkspaceProvider {
