...
import dev.aarso.domain.curation.FormState
import dev.aarso.domain.curation.GhostBranch
import dev.aarso.domain.curation.GhostReason
import dev.aarso.domain.curation.MessageBookmark
import dev.aarso.domain.curation.MessageRef
 ...
 * [dev.aarso.data.dao] interfaces with one store, since these six annotation types are read and
