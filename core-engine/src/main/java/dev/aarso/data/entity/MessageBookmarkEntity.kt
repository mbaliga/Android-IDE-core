...
/** Room representation of [dev.aarso.domain.curation.MessageBookmark]. Indexed by [msgId] since every read is "bookmarks for this message" or "bookmarks for this conversation." */
