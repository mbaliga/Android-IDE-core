...
/**
 * Room representation of [dev.aarso.domain.thread.ThreadMarker] (THREAD_TOPOLOGY_PLAN.md's
 ...
 * lookup, same shape [dev.aarso.data.entity.VersionEntity]'s `branchTipMsgId` index serves).
 */
